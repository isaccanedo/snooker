package br.com.isaccanedo.snooker;
...
public class Snooker extends Panel implements Runnable, MouseListener,
        MouseMotionListener {
    ...
    public Snooker() {
        ...
        Frame frame = new Frame("Jogo de Sinuca - ISAC CANEDO DE ALMEIDA");
        frame.add(this);
    ...
    public void makeScreen(Graphics screenGraphics) {
        ...
        if (a == 0) {
            ...
            int l1 = getHeight() / 2;
            screenGraphics.setColor(Color.BLACK);
            screenGraphics.drawString("", k1 + 2, l1 + 2);
            ...
            screenGraphics.drawString("Começar o Jogo", k1, l1);
        }
    }
